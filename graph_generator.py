...
class GraphGenerator:
    ...
    def create_weekly_graph(self):
        ...
        # Create figure
        fig = Figure(figsize=config.GRAPH_FIGSIZE, dpi=config.GRAPH_DPI)
    ...
    def create_category_pie_chart(self, trans_type='sales', period='month'):
    ...
    def create_profit_trend_graph(self):
    ...
    def create_handler_performance_graph(self, handler_data):
